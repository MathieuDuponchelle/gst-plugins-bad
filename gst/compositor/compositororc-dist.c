...
void compositor_orc_overlay_bgra (guint8 * ORC_RESTRICT d1, int d1_stride,
    const guint8 * ORC_RESTRICT s1, int s1_stride, int p1, int n, int m);
void compositor_video_convert_orc_memcpy_2d (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_I420_UYVY (guint8 * ORC_RESTRICT d1,
...
void compositor_video_convert_orc_convert_I420_YUY2 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3,
    const guint8 * ORC_RESTRICT s4, int n);
void compositor_video_convert_orc_convert_I420_AYUV (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3,
    const guint8 * ORC_RESTRICT s4, int n);
void compositor_video_convert_orc_convert_YUY2_I420 (guint8 * ORC_RESTRICT d1,
...
void compositor_video_convert_orc_convert_UYVY_YUY2 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_planar_chroma_420_422 (guint8 *
    ORC_RESTRICT d1, int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_planar_chroma_420_444 (guint8 *
    ORC_RESTRICT d1, int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_planar_chroma_422_444 (guint8 *
    ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_planar_chroma_444_422 (guint8 *
    ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_planar_chroma_444_420 (guint8 *
    ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m);
void compositor_video_convert_orc_planar_chroma_422_420 (guint8 *
    ORC_RESTRICT d1, int d1_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m);
void compositor_video_convert_orc_convert_YUY2_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_UYVY_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_YUY2_Y42B (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_UYVY_Y42B (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_YUY2_Y444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_UYVY_Y444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_UYVY_I420 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    guint8 * ORC_RESTRICT d4, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, int n);
void compositor_video_convert_orc_convert_AYUV_I420 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
...
void compositor_video_convert_orc_convert_AYUV_YUY2 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_AYUV_UYVY (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_AYUV_Y42B (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_AYUV_Y444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_Y42B_YUY2 (guint8 * ORC_RESTRICT d1,
...
void compositor_video_convert_orc_convert_Y42B_UYVY (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m);
void compositor_video_convert_orc_convert_Y42B_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m);
void compositor_video_convert_orc_convert_Y444_YUY2 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m);
void compositor_video_convert_orc_convert_Y444_UYVY (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m);
void compositor_video_convert_orc_convert_Y444_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m);
void compositor_video_convert_orc_convert_AYUV_ARGB (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_AYUV_BGRA (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_AYUV_ABGR (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_AYUV_RGBA (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m);
void compositor_video_convert_orc_convert_I420_BGRA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n);
void compositor_video_convert_orc_convert_I420_BGRA_avg (guint8 *
    ORC_RESTRICT d1, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3,
    const guint8 * ORC_RESTRICT s4, const guint8 * ORC_RESTRICT s5, int n);
void compositor_video_convert_orc_getline_I420 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n);
void compositor_video_convert_orc_getline_YUV9 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n);
void compositor_video_convert_orc_getline_YUY2 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_UYVY (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_YVYU (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_Y42B (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n);
void compositor_video_convert_orc_getline_Y444 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n);
void compositor_video_convert_orc_getline_Y800 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_Y16 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_BGRA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_ABGR (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_RGBA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_getline_NV12 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n);
void compositor_video_convert_orc_getline_NV21 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n);
void compositor_video_convert_orc_getline_A420 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int n);
void compositor_video_convert_orc_putline_I420 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_YUY2 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_YVYU (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_UYVY (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_Y42B (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_Y444 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_Y800 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_Y16 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_BGRA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_ABGR (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_RGBA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_NV12 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_NV21 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n);
void compositor_video_convert_orc_putline_A420 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
...
/* compositor_video_convert_orc_memcpy_2d */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_memcpy_2d (guint8 * ORC_RESTRICT d1, int d1_stride,
    const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_memcpy_2d (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int j;
  int n = ex->n;
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_memcpy_2d);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p, "compositor_video_convert_orc_memcpy_2d");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_memcpy_2d);
      orc_program_add_destination (p, 1, "d1");
      orc_program_add_source (p, 1, "s1");
...
/* compositor_video_convert_orc_convert_I420_UYVY */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_I420_UYVY (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3,
    const guint8 * ORC_RESTRICT s4, int n)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_I420_UYVY (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s4, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_I420_UYVY);
#else
      p = orc_program_new ();
...
/* compositor_video_convert_orc_convert_I420_YUY2 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_I420_YUY2 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3,
    const guint8 * ORC_RESTRICT s4, int n)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_I420_YUY2 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s4, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_I420_YUY2);
#else
      p = orc_program_new ();
      orc_program_set_name (p,
          "compositor_video_convert_orc_convert_I420_YUY2");
...
/* compositor_video_convert_orc_convert_I420_AYUV */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_I420_AYUV (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, const guint8 * ORC_RESTRICT s3,
    const guint8 * ORC_RESTRICT s4, int n)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_I420_AYUV (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s4, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_I420_AYUV);
#else
      p = orc_program_new ();
      orc_program_set_name (p,
          "compositor_video_convert_orc_convert_I420_AYUV");
...
/* compositor_video_convert_orc_convert_YUY2_I420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_YUY2_I420 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    guint8 * ORC_RESTRICT d4, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, int n)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_YUY2_I420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_YUY2_I420);
#else
      p = orc_program_new ();
      orc_program_set_name (p,
          "compositor_video_convert_orc_convert_YUY2_I420");
...
/* compositor_video_convert_orc_convert_UYVY_YUY2 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_UYVY_YUY2 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_UYVY_YUY2 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_UYVY_YUY2);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_planar_chroma_420_422 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_planar_chroma_420_422 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_planar_chroma_420_422 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_planar_chroma_420_422);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_planar_chroma_420_444 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_planar_chroma_420_444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_planar_chroma_420_444 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_planar_chroma_420_444);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_planar_chroma_422_444 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_planar_chroma_422_444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_planar_chroma_422_444 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_planar_chroma_422_444);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_planar_chroma_444_422 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_planar_chroma_444_422 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_planar_chroma_444_422 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_planar_chroma_444_422);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_planar_chroma_444_420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_planar_chroma_444_420 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_planar_chroma_444_420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_planar_chroma_444_420);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_planar_chroma_422_420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_planar_chroma_422_420 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_planar_chroma_422_420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_planar_chroma_422_420);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_YUY2_AYUV */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_YUY2_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_YUY2_AYUV (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_YUY2_AYUV);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_UYVY_AYUV */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_UYVY_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_UYVY_AYUV (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_UYVY_AYUV);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_YUY2_Y42B */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_YUY2_Y42B (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_YUY2_Y42B (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_YUY2_Y42B);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_UYVY_Y42B */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_UYVY_Y42B (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_UYVY_Y42B (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_UYVY_Y42B);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_YUY2_Y444 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_YUY2_Y444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_YUY2_Y444 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_YUY2_Y444);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_UYVY_Y444 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_UYVY_Y444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_UYVY_Y444 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_UYVY_Y444);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_UYVY_I420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_UYVY_I420 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    guint8 * ORC_RESTRICT d4, const guint8 * ORC_RESTRICT s1,
    const guint8 * ORC_RESTRICT s2, int n)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_UYVY_I420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_UYVY_I420);
#else
      p = orc_program_new ();
      orc_program_set_name (p,
          "compositor_video_convert_orc_convert_UYVY_I420");
...
/* compositor_video_convert_orc_convert_AYUV_I420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_I420 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, guint8 * ORC_RESTRICT d4,
    int d4_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m)
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_I420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s2, int s2_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_I420);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_YUY2 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_YUY2 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_YUY2 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_YUY2);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_UYVY */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_UYVY (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_UYVY (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_UYVY);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_Y42B */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_Y42B (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_Y42B (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_Y42B);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_Y444 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_Y444 (guint8 * ORC_RESTRICT d1,
    int d1_stride, guint8 * ORC_RESTRICT d2, int d2_stride,
    guint8 * ORC_RESTRICT d3, int d3_stride, const guint8 * ORC_RESTRICT s1,
    int s1_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_Y444 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_Y444);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_Y42B_YUY2 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_Y42B_YUY2 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_Y42B_YUY2 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_Y42B_YUY2);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_Y42B_UYVY */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_Y42B_UYVY (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_Y42B_UYVY (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_Y42B_UYVY);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_Y42B_AYUV */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_Y42B_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_Y42B_AYUV (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_Y42B_AYUV);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_Y444_YUY2 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_Y444_YUY2 (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_Y444_YUY2 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_Y444_YUY2);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_Y444_UYVY */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_Y444_UYVY (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_Y444_UYVY (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_Y444_UYVY);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_Y444_AYUV */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_Y444_AYUV (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride,
    const guint8 * ORC_RESTRICT s2, int s2_stride,
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
...
#else
static void
_backup_compositor_video_convert_orc_convert_Y444_AYUV (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    const guint8 * ORC_RESTRICT s3, int s3_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_Y444_AYUV);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_ARGB */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_ARGB (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_ARGB (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_ARGB);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_BGRA */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_BGRA (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_BGRA (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_BGRA);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_ABGR */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_ABGR (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_ABGR (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_ABGR);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_AYUV_RGBA */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_AYUV_RGBA (guint8 * ORC_RESTRICT d1,
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  int i;
  int j;
...
#else
static void
_backup_compositor_video_convert_orc_convert_AYUV_RGBA (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int j;
    ...
    int d1_stride, const guint8 * ORC_RESTRICT s1, int s1_stride, int n, int m)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_AYUV_RGBA);
#else
      p = orc_program_new ();
      orc_program_set_2d (p);
      orc_program_set_name (p,
...
/* compositor_video_convert_orc_convert_I420_BGRA */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_I420_BGRA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_convert_I420_BGRA (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_I420_BGRA);
#else
      p = orc_program_new ();
      orc_program_set_name (p,
          "compositor_video_convert_orc_convert_I420_BGRA");
...
/* compositor_video_convert_orc_convert_I420_BGRA_avg */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_convert_I420_BGRA_avg (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
...
#else
static void
_backup_compositor_video_convert_orc_convert_I420_BGRA_avg (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s5, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_convert_I420_BGRA_avg);
#else
      p = orc_program_new ();
      orc_program_set_name (p,
          "compositor_video_convert_orc_convert_I420_BGRA_avg");
...
/* compositor_video_convert_orc_getline_I420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_I420 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_getline_I420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_I420);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_I420");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_I420);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 1, "s1");
...
/* compositor_video_convert_orc_getline_YUV9 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_YUV9 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_getline_YUV9 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_YUV9);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_YUV9");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_YUV9);
      orc_program_add_destination (p, 8, "d1");
      orc_program_add_source (p, 2, "s1");
...
/* compositor_video_convert_orc_getline_YUY2 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_YUY2 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_YUY2 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_YUY2);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_YUY2");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_YUY2);
      orc_program_add_destination (p, 8, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_getline_UYVY */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_UYVY (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_UYVY (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_UYVY);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_UYVY");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_UYVY);
      orc_program_add_destination (p, 8, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_getline_YVYU */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_YVYU (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_YVYU (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_YVYU);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_YVYU");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_YVYU);
      orc_program_add_destination (p, 8, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_getline_Y42B */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_Y42B (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_getline_Y42B (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y42B);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_Y42B");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y42B);
      orc_program_add_destination (p, 8, "d1");
      orc_program_add_source (p, 2, "s1");
...
/* compositor_video_convert_orc_getline_Y444 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_Y444 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_getline_Y444 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s3, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y444);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_Y444");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y444);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 1, "s1");
...
/* compositor_video_convert_orc_getline_Y800 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_Y800 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_Y800 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y800);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_Y800");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y800);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 1, "s1");
...
/* compositor_video_convert_orc_getline_Y16 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_Y16 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_Y16 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union32 *ORC_RESTRICT ptr0;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y16);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_Y16");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_Y16);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 2, "s1");
...
/* compositor_video_convert_orc_getline_BGRA */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_BGRA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_BGRA (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_BGRA);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_BGRA");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_BGRA);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_getline_ABGR */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_ABGR (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_ABGR (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_ABGR);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_ABGR");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_ABGR);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_getline_RGBA */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_RGBA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_RGBA (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_RGBA);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_RGBA");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_RGBA);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_getline_NV12 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_NV12 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  int i;
  orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_NV12 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_NV12);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_NV12");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_NV12);
      orc_program_add_destination (p, 8, "d1");
      orc_program_add_source (p, 2, "s1");
...
/* compositor_video_convert_orc_getline_NV21 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_NV21 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  int i;
  orc_union64 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_getline_NV21 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_NV21);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_NV21");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_NV21);
      orc_program_add_destination (p, 8, "d1");
      orc_program_add_source (p, 2, "s1");
...
/* compositor_video_convert_orc_getline_A420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_getline_A420 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, const guint8 * ORC_RESTRICT s2,
    const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_getline_A420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s3, const guint8 * ORC_RESTRICT s4, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_A420);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_getline_A420");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_getline_A420);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 1, "s1");
...
/* compositor_video_convert_orc_putline_I420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_I420 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_putline_I420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_I420);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_I420");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_I420);
      orc_program_add_destination (p, 2, "d1");
      orc_program_add_destination (p, 1, "d2");
...
/* compositor_video_convert_orc_putline_YUY2 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_YUY2 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_YUY2 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_YUY2);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_YUY2");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_YUY2);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 8, "s1");
...
/* compositor_video_convert_orc_putline_YVYU */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_YVYU (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_YVYU (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_YVYU);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_YVYU");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_YVYU);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 8, "s1");
...
/* compositor_video_convert_orc_putline_UYVY */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_UYVY (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_UYVY (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_UYVY);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_UYVY");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_UYVY);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 8, "s1");
...
/* compositor_video_convert_orc_putline_Y42B */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_Y42B (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_putline_Y42B (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y42B);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_Y42B");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y42B);
      orc_program_add_destination (p, 2, "d1");
      orc_program_add_destination (p, 1, "d2");
...
/* compositor_video_convert_orc_putline_Y444 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_Y444 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_putline_Y444 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y444);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_Y444");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y444);
      orc_program_add_destination (p, 1, "d1");
      orc_program_add_destination (p, 1, "d2");
...
/* compositor_video_convert_orc_putline_Y800 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_Y800 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_int8 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_Y800 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y800);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_Y800");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y800);
      orc_program_add_destination (p, 1, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_putline_Y16 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_Y16 (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_Y16 (OrcExecutor * ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
  orc_union16 *ORC_RESTRICT ptr0;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y16);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_Y16");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_Y16);
      orc_program_add_destination (p, 2, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_putline_BGRA */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_BGRA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_BGRA (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_BGRA);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_BGRA");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_BGRA);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_putline_ABGR */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_ABGR (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_ABGR (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_ABGR);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_ABGR");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_ABGR);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_putline_RGBA */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_RGBA (guint8 * ORC_RESTRICT d1,
    const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union32 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_RGBA (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_RGBA);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_RGBA");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_RGBA);
      orc_program_add_destination (p, 4, "d1");
      orc_program_add_source (p, 4, "s1");
...
/* compositor_video_convert_orc_putline_NV12 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_NV12 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_NV12 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_NV12);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_NV12");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_NV12);
      orc_program_add_destination (p, 2, "d1");
      orc_program_add_destination (p, 2, "d2");
...
/* compositor_video_convert_orc_putline_NV21 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_NV21 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
  orc_union16 *ORC_RESTRICT ptr0;
...
#else
static void
_backup_compositor_video_convert_orc_putline_NV21 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    guint8 * ORC_RESTRICT d2, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_NV21);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_NV21");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_NV21);
      orc_program_add_destination (p, 2, "d1");
      orc_program_add_destination (p, 2, "d2");
...
/* compositor_video_convert_orc_putline_A420 */
#ifdef DISABLE_ORC
void
compositor_video_convert_orc_putline_A420 (guint8 * ORC_RESTRICT d1,
    guint8 * ORC_RESTRICT d2, guint8 * ORC_RESTRICT d3,
    guint8 * ORC_RESTRICT d4, const guint8 * ORC_RESTRICT s1, int n)
{
  int i;
...
#else
static void
_backup_compositor_video_convert_orc_putline_A420 (OrcExecutor *
    ORC_RESTRICT ex)
{
  int i;
  int n = ex->n;
    ...
    guint8 * ORC_RESTRICT d4, const guint8 * ORC_RESTRICT s1, int n)
{
  ...
  if (!p_inited) {
    ...
    if (!p_inited) {
      ...
      p = orc_program_new_from_static_bytecode (bc);
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_A420);
#else
      p = orc_program_new ();
      orc_program_set_name (p, "compositor_video_convert_orc_putline_A420");
      orc_program_set_backup_function (p,
          _backup_compositor_video_convert_orc_putline_A420);
      orc_program_add_destination (p, 2, "d1");
      orc_program_add_destination (p, 1, "d2");
